			...
			<div className="container mx-auto px-4 py-3">
				<div className="flex flex-wrap justify-between items-center">
					...
					<nav className="flex flex-wrap gap-4 items-center">
						...
						{user ? (
							<button className="cursor-pointer bg-gray-700 hover:bg-gray-600 text-white px-4 py-2 rounded-md flex items-center transition duration-300 ease-in-out">
								<LogOut size={18} />
							...
							<>
								...
								<Link
									to={"/login"}
									className="flex items-center text-white bg-gray-600 hover:bg-gray-500 px-4 py-2 rounded-md font-medium transition duration-300 ease-in-out"
								>
